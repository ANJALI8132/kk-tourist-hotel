                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-center pb-5">
                        <div class="footer-logo">
                            <a href="index"><img src="assets/img/footer/footer-logo.png" class="img-fluid" alt=""></a>
                        </div>
                    </div> 
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="">
                                                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="requests"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <!-- Thankyou Popup Start -->
    <div id="tyModalnew" class="modal fade" role="dialog">
            <div class="modal-dialog">
              <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="ty-modal-body text-center">
                    <div class="text-center check-done"><i class="fa fa-check-circle"></i></div>
                  <h2>We have received your enquiry and the <br> team will contact them soon.</h2>
                </div>
              </div>
